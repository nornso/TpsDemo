...
public struct ThirdPersonCharacterProcessor : IKinematicCharacterProcessor
{
    ...
    public unsafe void OnUpdate()
    {
        ...
        {
            KinematicCharacterUtilities.DefaultMethods.UpdateGroundPushing(ref CollisionWorld, ref PhysicsMassFromEntity, ref CharacterDeferredImpulsesBuffer, ref CharacterBody, DeltaTime, ThirdPersonCharacter.Gravity, 1f); // safe to remove if not needed
        }
